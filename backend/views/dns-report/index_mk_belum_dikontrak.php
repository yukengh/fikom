...
$this->title = 'DAFTAR MAHASISWA YANG BELUM KONTRAK MATAKULIAH';
        ...
        'columns' => [
         ...
         [
                ...
                'buttons' => [
                    '1' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', $url, [
                            'title' => Yii::t('app', 'Matakuliah yang belum Dikontrak'),
                            'data-method' => 'post',
                            'data-pjax' => '0',
                        ]);
                    }                    
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    ...
                    switch ($action) {
                        case('1'): return Url::to(['dns-report/view-matakuliah-belum-dikontrak', 'id' => $id]); break;
                    }
                }                
            ],     
        ],
